...
export default function AnnouncementSectionAbu({
  guestName,
  ...
  return (
    <section className="announcement-section">
      ...
      >
        {/* cross */}
        <div className="announcment-section_cross">✝</div>

        {/* Introduction */}
        <p className="announcement-section__intro">
          We joyfully announce the wedding of our beloved children,
        </p>
        {/* Bride */}
        ...
        <p className="announcement-section__parent">Mrs </p>

        <p className="announcement-section__and">And</p>

        <p className="announcement-section__parent">Ato Alemayew </p>
      </motion.div>
    </section>
  );
}
